...
class AddressTwoScreen extends GetWidget<AddressTwoController> {
  const AddressTwoScreen({Key? key}) : super(key: key);
        ...
        child: Scaffold(
            ...
            body: SizedBox(
                ...
                child: Column(children: [
                  _buildSeventeen(),
                  Divider(color: appTheme.gray300A9),
                  ...
                  CustomElevatedButton(
                      ...
                      margin: EdgeInsets.only(left: 11.h, right: 21.h),
  ...
  PreferredSizeWidget _buildAppBar() {
    return CustomAppBar(
        ...
        leading: AppbarLeadingImage(
            ...
            margin: EdgeInsets.only(left: 28.h, top: 23.v, bottom: 23.v),
            onTap: () {
              onTapImage();
            }),
        title: AppbarSubtitle(
            text: "lbl_address".tr, margin: EdgeInsets.only(left: 24.h)),
        ...
        child: Row(
            ...
            children: [
              ...
              Padding(
                  ...
                  child: Text("msg_add_new_addrress".tr,
                      style: CustomTextStyles
                          .titleMediumAbhayaLibreMediumBlack900)),
              Spacer(),
              CustomImageView(
                  ...
                  height: 10.v,
                  width: 5.h,
                  margin: EdgeInsets.only(top: 13.v, right: 4.h, bottom: 9.v))
            ]));
  }
              ...
              SizedBox(
                  ...
                  child: Stack(alignment: Alignment.bottomCenter, children: [
                            ...
                            child: Column(
                                ...
                                children: [
                                  ...
                                  Obx(() => CustomCheckboxButton(
                                      ...
                                      onChange: (value) {
                                        controller.setAddressDefault.value =
                                            value;
                                      })),
                                  SizedBox(height: 5.v)
                                ]))),
                    Align(
                        ...
                        child: SizedBox(
                            width: 301.h,
                            child: Divider(color: appTheme.gray300A9))),
                    Align(
                        alignment: Alignment.bottomCenter,
                        child: Padding(
                            padding: EdgeInsets.only(left: 14.h, bottom: 43.v),
                            child: Column(
                                mainAxisSize: MainAxisSize.min,
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text("msg_rosecrans_ave_suite".tr,
                                      style: CustomTextStyles
                                          .titleSmallAbhayaLibreMediumBluegray40001),
                                  SizedBox(height: 5.v),
                                  Text("msg_501_425_906_4618".tr,
                                      style: CustomTextStyles
                                          .titleSmallAbhayaLibreMediumBluegray40001),
                                  SizedBox(height: 6.v),
                                  Text("lbl_zip_code_92053".tr,
                                      style: CustomTextStyles
                                          .titleSmallAbhayaLibreMediumBluegray40001),
                                  CustomIconButton(
                                      height: 40.adaptSize,
                                      ...
                                      child: CustomImageView(
                                          imagePath:
                                              ImageConstant.imgControlsButton))
                                ])))
                  ])),
                            ...
                            child: Column(
                                ...
                                children: [
                                  Padding(
                                      ...
                                      child: Text("lbl_paris".tr,
                                          style: CustomTextStyles
                                              .titleSmallAbhayaLibreMediumBlack900)),
                                  SizedBox(height: 8.v),
                                  Padding(
                                      padding: EdgeInsets.only(left: 5.h),
                                      child: Text("msg_fondamenta_zitelle".tr,
                                          style: CustomTextStyles
                                              .titleSmallAbhayaLibreMediumBluegray40001)),
                                  SizedBox(height: 1.v),
                                  Padding(
                                      padding: EdgeInsets.only(left: 5.h),
                                      child: Text("msg_501_425_906_4618".tr,
                                          style: CustomTextStyles
                                              .titleSmallAbhayaLibreMediumBluegray40001)),
                                  SizedBox(height: 7.v),
                                  Padding(
                                      padding: EdgeInsets.only(left: 5.h),
                                      child: Text("lbl_zip_code_92053".tr,
                                          style: CustomTextStyles
                                              .titleSmallAbhayaLibreMediumBluegray40001)),
